...
def create(tid, params):
    ...
    # ---------------------------------------------------
    # print('task.create, type of queue:', type(q))
    # print('task.create, length before enqueue:', len(q))
    # ---------------------------------------------------
    q.enqueue_call(func=_create_thread, args=(tid, params),
        job_id="task.create/{}".format(tid))
    # ---------------------------------------------------
    # print('task.create, length after enqueue:', len(q))
    # print(f'task.create, job IDs from the queue: {q.job_ids}')
    # print(f'task.create, job list from the queue: {q.jobs}')
    # w = django_rq.get_worker('default')
    # print(f'task.create, worker: {type(w)}')
    # ---------------------------------------------------
...
def get_frame_path(tid, frame):
    ...
    # ---------------------------------------------------
    print('task.get_frame_path', path)
    # ---------------------------------------------------
    return path
...
def _create_thread(tid, params):
    ...
    # ----------------------------------------------------
    print('task._create_thread, got into it')
    # ----------------------------------------------------
